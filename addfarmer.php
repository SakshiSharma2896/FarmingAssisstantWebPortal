...
$femail= $_POST['femail'];
	...
	values('$fid', '$fname', '$fcontact', '$faddress', '$fpassword', '$fcpassword', '$femail')";
...
<body>
<h1 style="margin-top: 75px;"><font color="red" face="Garamond"><center>ADD FARMER</font></center></h1>
<center>
...
<input type="email" placeholder="Enter Email" name="femail" style="width:30%;height:30px" required><br>
<br><br>		
